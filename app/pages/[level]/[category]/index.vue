      ...
      <div v-else>
        ...
        <div class="mb-12">
          <div class="flex items-center gap-4 mb-4">
            <div
              class="flex h-16 w-16 items-center justify-center rounded-xl bg-primary-100 dark:bg-primary-900"
            >
              <UIcon
  ...
  meta: [
    {
      ...
      content:
        ...
        `Tematy z kategorii ${category.value?.name}`,
    },
  ],
}));
</script>
