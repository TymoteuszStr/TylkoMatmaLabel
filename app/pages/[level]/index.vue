    ...
    <div class="container mx-auto px-4 py-12">
      ...
      <div v-else>
        ...
        <div class="mb-12">
          ...
          <p v-if="educationLevel?.description" class="mt-4 text-lg text-gray-600 dark:text-gray-400">
            {{ educationLevel.description }}
          </p>
        </div>

        <!-- Categories Grid -->
        <div v-if="categories.length > 0" class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <UCard
          ...
          >
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p v-if="category.description" class="mt-2 text-sm text-gray-600 dark:text-gray-400">
...
// SEO
useHead(() => ({
  title: educationLevel.value ? `${educationLevel.value.name} - TylkoMatma` : 'TylkoMatma',
  meta: [
    {
      name: 'description',
      content: educationLevel.value?.description || `Materiały edukacyjne dla ${educationLevel.value?.name}`,
    },
  ],
}))
</script>
