<template>
  <div>
    <!-- Hero Section -->
    <section class="bg-gradient-to-b from-primary-50 to-white py-16 dark:from-gray-900 dark:to-gray-950 md:py-24">
      <div class="container mx-auto px-4">
        <div class="mx-auto max-w-3xl text-center">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
            Ucz się matematyki
            <span class="text-primary-600 dark:text-primary-400">w przystępny sposób</span>
          </h1>
          <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
            Kompleksowa platforma edukacyjna z materiałami, przykładami i testami.
            Wszystko czego potrzebujesz aby opanować matematykę na poziomie liceum.
          </p>
    ...
    <section class="py-16 md:py-24">
      <div class="container mx-auto px-4">
        ...
        <div class="mt-16 grid gap-8 md:grid-cols-3">
          ...
          <div class="flex flex-col items-center text-center">
            <div class="flex h-16 w-16 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900">
              <UIcon name="i-heroicons-clipboard-document-check" class="text-3xl text-primary-600 dark:text-primary-400" />
            </div>
            <h3 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">
              Testy ABCD
            </h3>
          ...
          <div class="flex flex-col items-center text-center">
            <div class="flex h-16 w-16 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900">
              <UIcon name="i-heroicons-chart-bar" class="text-3xl text-primary-600 dark:text-primary-400" />
            </div>
            <h3 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">
              Śledź postępy
            </h3>
    ...
    <section id="levels" class="bg-gray-50 py-16 dark:bg-gray-900 md:py-24">
      <div class="container mx-auto px-4">
        ...
        <!-- Education Levels -->
        <div v-else-if="educationLevels.length > 0" class="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <UCard
          ...
          >
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p v-if="level.description" class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                  {{ level.description }}
                </p>
              </div>
            </div>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Kompleksowa platforma edukacyjna do nauki matematyki. Materiały, testy i śledzenie postępów dla uczniów liceum.',
    },
    {
      name: 'keywords',
